                ...
                <div class="kt-menu-item">
                    <a href="#">
                        <div class="kt-menu-link flex items-center gap-[10px] ps-[10px] pe-[10px] py-[6px]">
                            ...
                            <span class="kt-menu-title text-sm font-medium text-foreground
                       kt-menu-item-active:text-primary
                       kt-menu-link-hover:!text-primary">Content Source</span>
                        </div>
                    </a>
                </div>
                ...
                <div class="kt-menu-item">
                    <a href="#">
                        <div class="kt-menu-link flex items-center gap-[10px] ps-[10px] pe-[10px] py-[6px]">
                            ...
                            <span class="kt-menu-title text-sm font-medium text-foreground
                       kt-menu-item-active:text-primary
                       kt-menu-link-hover:!text-primary">Content Ideas</span>
                        </div>
                    </a>
                </div>
                ...
                <div class="kt-menu-item">
                    <a href="#">
                        <div class="kt-menu-link flex items-center gap-[10px] ps-[10px] pe-[10px] py-[6px]">
                            ...
                            <span class="kt-menu-title text-sm font-medium text-foreground
                       kt-menu-item-active:text-primary
                       kt-menu-link-hover:!text-primary">Account Analytics</span>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="{{ route('admin.user.index') }}">
                        <div class="kt-menu-link flex items-center gap-[10px] ps-[10px] pe-[10px] py-[6px]">
                         ...
                         <i class="ki-filled ki-users text-lg">
                            ...
                            <span class="kt-menu-title text-sm font-medium text-foreground
                       kt-menu-item-active:text-primary
                       kt-menu-link-hover:!text-primary">Manage User</span>
                        </div>
                    </a>
                </div>
