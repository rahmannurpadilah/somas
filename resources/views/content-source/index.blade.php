    ...
    <div class="kt-container-fixed">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            @foreach ($sources as $s)
                <div class="kt-card">
                    <div class="kt-card-content lg:pt-9 lg:pb-7.5 space-y-4">

                        <div>
                            <h3 class="text-sm text-secondary-foreground">Platform</h3>
                            <span>{{ $s->platform }}</span>
                        </div>

                        <div>
                            <h3 class="text-sm text-secondary-foreground">Type</h3>
                            <span>{{ $s->type }}</span>
                        </div>

                        <div>
                            <h3 class="text-sm text-secondary-foreground">Identifier</h3>
                            <span class="kt-badge-outline kt-badge-success">
                                {{ $s->identifier }}
                            </span>
                        </div>

                        <div>
                            <h3 class="text-sm text-secondary-foreground">Category</h3>
                            <span>{{ $s->category }}</span>
                        </div>

                        <div>
                            <h3 class="text-sm text-secondary-foreground">Status</h3>
            ...
            <div class="flex flex-wrap">
                <div class="flex">
                    <label class="kt-input">
                        ...
                        <input data-kt-datatable-search="#team_crew_table" placeholder="Search content" type="text" />
                    </label>
                </div>
            </div>
        </div>
